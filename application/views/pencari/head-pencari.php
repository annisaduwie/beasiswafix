          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo base_url('AdminLTE/dist/img/b.png')?>" class="user-image" alt="User Image">
                <span class="hidden-xs"><?PHP echo  $_SESSION["usernameb"] ;?></span>
              </a>
            </li>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li>
              <a href="dashboardBendahara">
                <i class="fa fa-pie-chart"></i> <span>Dashboard</span>
              </a>
            </li>
            <li>
              <a href="kotak">
                <i class="fa fa-pie-chart"></i> <span>Kotak</span>
              </a>
            </li>
            <li>
              <a href="barangbendahara">
                <i class="fa fa-th"></i> <span>Barang</span>
              </a>
            </li>
            <li>
              <a href="penjual">
                <i class="fa fa-files-o"></i> <span>Penjual</span>
              </a>
            </li>
            <li>
              <a href="pembeli">
                <i class="fa fa-files-o"></i> <span>Pembeli</span>
              </a>
            </li>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-book"></i> <span>Saldo</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="saldo"><i class="fa fa-circle-o text-red"></i> Penambahan</a></li>
                <li><a href="penarikansaldo"><i class="fa fa-circle-o text-yellow"></i> Penarikan</a></li>
              </ul>
            </li>
          </ul>
        </section>
