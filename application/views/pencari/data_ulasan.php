...
<head>
 ...
 <div class="box box-primary">
     ...
     <div class="box-header with-border">
      <h3 class="box-title">Daftar Ulasan</h3>
      ...
      <section class="content">
            ...
            <div class="row">
              ...
              $query= $this->db->query("SELECT * from pencari, ulasan, universitas WHERE pencari.id_pencari=ulasan.id_pencari AND ulasan.id_universitas=universitas.id_universitas AND pencari.id_pencari='$id_pencari' GROUP BY pencari.id_pencari order by post_ulasan")->num_rows();
              ?>
